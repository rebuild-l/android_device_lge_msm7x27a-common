...
PREBUILT_WLAN_MODULES:
	mkdir -p $(KERNEL_MODULES_OUT)/volans
	cp device/lge/msm7x27a-common/prebuilt/WCN1314_rf.ko $(KERNEL_MODULES_OUT)/volans/WCN1314_rf.ko
	ln -sf /system/lib/modules/volans/WCN1314_rf.ko $(TARGET_OUT)/lib/modules/wlan.ko
