...
LINEEND=" \\"
COUNT=`wc -l ../msm7x27a-common/proprietary-files.txt | awk {'print $1'}`
DISM=`egrep -c '(^#|^$)' ../msm7x27a-common/proprietary-files.txt`
COUNT=`expr $COUNT - $DISM`
...
LINEEND=" \\"
COUNT=`wc -l ../msm7x27a-common/common-proprietary-files.txt | awk {'print $1'}`
DISM=`egrep -c '(^#|^$)' ../msm7x27a-common/common-proprietary-files.txt`
COUNT=`expr $COUNT - $DISM`
